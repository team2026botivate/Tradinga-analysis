...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-white to-white dark:from-slate-900 dark:to-slate-800 p-6">
      <div className="w-full max-w-md">
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-slate-200/70 dark:border-slate-700/70 rounded-3xl shadow-xl overflow-hidden">
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5" autoComplete="on">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoCapitalize="none"
                    autoCorrect="off"
                    className="w-full pl-10 pr-3 py-3 rounded-xl bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-3 rounded-xl bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">Forgot password?</button>
              </div>
          ...
          <div className="px-8 py-4 bg-slate-50/80 dark:bg-slate-900/40 border-t border-slate-200/70 dark:border-slate-700/70 text-center text-sm text-slate-600 dark:text-slate-400">
            Powered by{' '}
            <a
